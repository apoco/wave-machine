...
frequency of the notes in the octave below them. This might explain why two notes in the same octave sound have such a harmonious sound to them.

So basically, in a nutshell, the frequency for tones is a *geometric* series, with an even geometric increase between tones. What are these *tones*
